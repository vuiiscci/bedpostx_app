...
# Set up FSL
ENV LD_LIBRARY_PATH "${LD_LIBRARY_PATH}:/extra/fsl_5_0_10_bedpostx_cuda_8/lib"
ENV PATH "${PATH}:/extra/fsl_5_0_10_bedpostx_cuda_8/bin"
ENV FSLDIR /extra/fsl_5_0_10_bedpostx_cuda_8
